...
public class IrUtils {
    ...
    public static ArrayList<Integer> base64ToPulse(String base64Code) {
    ...
    public static List<String> pulsesToNec(ArrayList<Integer> pulses) {
    ...
    public static String pulsesToBase64(ArrayList<Long> pulses) {
    ...
    public static String necToBase64(long address, Long data) {
        ArrayList<Long> pulses = necToPulses(address, data);
