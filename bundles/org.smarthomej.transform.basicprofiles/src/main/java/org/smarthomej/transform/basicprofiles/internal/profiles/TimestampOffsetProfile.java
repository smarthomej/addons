...
import org.smarthomej.transform.basicprofiles.internal.config.BasicProfilesConfigOptionsProvider;
import org.smarthomej.transform.basicprofiles.internal.factory.BasicProfilesFactory;

/**
 * Applies the given parameter "offset" to a {@link DateTimeType} state.
 *
 * Options for the "timezone" parameter are provided by the {@link BasicProfilesConfigOptionsProvider}.
 *
...
public class TimestampOffsetProfile implements StateProfile {
    ...
    public ProfileTypeUID getProfileTypeUID() {
        return BasicProfilesFactory.TIMESTAMP_OFFSET_TYPE_UID;
    }
