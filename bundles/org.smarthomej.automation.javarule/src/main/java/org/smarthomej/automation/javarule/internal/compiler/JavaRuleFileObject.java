...
/**
 * The {@link JavaRuleFileObject} is a custom {@link JavaFileObject} implementation
 *
...
public class JavaRuleFileObject implements JavaFileObject {
    ...
    private JavaRuleFileObject(URI uri, Kind kind) {
        this.uri = uri;
        this.kind = kind;
    }
    ...
    public static JavaFileObject sourceFileObject(URI uri) {
        return new JavaRuleFileObject(uri, Kind.SOURCE);
    }
    ...
    public static JavaFileObject classFileObject(URI uri) {
        return new JavaRuleFileObject(uri, Kind.CLASS);
    }
}
