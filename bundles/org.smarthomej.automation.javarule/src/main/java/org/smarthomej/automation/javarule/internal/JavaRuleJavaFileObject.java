...
/**
 * The {@link JavaRuleJavaFileObject} is a custom {@link JavaFileObject} implementation
 *
 * @author Jan N. Klug - Initial contribution
 */
@NonNullByDefault
public class JavaRuleJavaFileObject implements JavaFileObject {
    private final URI uri;
    private final Kind kind;

    private JavaRuleJavaFileObject(URI uri, Kind kind) {
        this.uri = uri;
        this.kind = kind;
    }
    ...
    public static JavaFileObject sourceFileObject(URI uri) {
        return new JavaRuleJavaFileObject(uri, Kind.SOURCE);
    }
    ...
    public static JavaFileObject classFileObject(URI uri) {
        return new JavaRuleJavaFileObject(uri, Kind.CLASS);
    }
